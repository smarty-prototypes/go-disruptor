...
// lowContentionSequencer is an alternative multi-writer Sequencer that uses ordered (serialized) commits instead of
...
// serializes commits which may cause contention with many producers (usually >= 3-4 simultaneous producers).
//
...
type lowContentionSequencer struct {
...
func newLowContentionSequencer(capacity uint32, reservedSequence *atomicSequence, waiter WaitStrategy) *lowContentionSequencer {
	return &lowContentionSequencer{
...
func (this *lowContentionSequencer) Reserve(count uint32) int64 {
...
func (this *lowContentionSequencer) TryReserve(count uint32) int64 {
	if count == 0 || count > this.capacity {
		return ErrReservationSize
	}
...
func (this *lowContentionSequencer) hasAvailableCapacity(previousReservedSequence, count int64) bool {
	var (
...
func (this *lowContentionSequencer) Commit(lower, upper int64) {
...
func (this *lowContentionSequencer) Load(_ int64) int64 { return this.committedSequence.Load() }
